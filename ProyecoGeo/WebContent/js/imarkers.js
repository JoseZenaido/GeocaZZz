...
function(){
	...
	var clickMarker1= function(){
		...
		info1.setContent('<h3>Monnterrey </h3><img src="imgnnnnn/gas2d.PNG"/>'
...
var clickMarker2= function(){
	var marker= this;
	var latLng= marker.getPosition();
	info2.setContent('<h3>Veracruz </h3><img src="img/gas2vvfv.PNG"/><img src="img/OilWell1.png"/>'+"<br /><br />"
...
var clickMarker4= function(){
	var marker= this;
	var latLng= marker.getPosition();
	info4.setContent('<h3>Durango</h3><img src="img/OilWell3.png"/><img src="imcccg/gas2.PNG"/>'+"<br /><br />"
			+'Latitude= ' +
		          latLng.lat() + '<br>Longitude= ' + latLng.lng()+"<br /><br />"+
